            ...
            >
                ...
                <div className="pt-4 pb-3 border-t border-border">
                    ...
                    <div className="mt-3 space-y-1">
                        <MobileNavLink href="/profile" onClick={() => setIsOpen(false)} isActive={false}>Profile</MobileNavLink>
                        <MobileNavLink href="/settings" onClick={() => setIsOpen(false)} isActive={false}>Settings</MobileNavLink>
                        <Button
                            variant="ghost"
...
function UserMenu({ userName, image }: { userName?: string, image?: string }) {
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center text-sm focus:outline-none">
                    ...
                    <span className="ml-2 hidden md:block text-foreground">{userName}</span>
